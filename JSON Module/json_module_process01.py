...
# You can think of dumps() as serializing the Python object into a  JSON object and returning a string. This is needed if you wish to transfer data across the internet.
