...
# Consider in our program we are using a mutable object like List but, after a certain point in our program we do not want any user to change or modify it. We are kind of warning the person reading the code that we do not have to modify this further in the program. In such cases, Frozensets can help us.
